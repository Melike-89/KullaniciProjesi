...
import tr.com.kullaniciprojesi.databinding.ActivityDetay2Binding
...
class DetayActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textViewEmailGoster.text=user?.email.toString()
            ...
            db.collection("users").document(userId).get()
                .addOnSuccessListener { document ->
                    if (document != null && document.exists()) {
                        ...
                        binding.textViewEmailGoster.text = eposta
                        binding.textView2ParolaGoster.text = parola
                        binding.textView3AdSoyadGoster.text = tamad
                        binding.textView4NumaraGoster.text = ogrenciNo
                    } else {
